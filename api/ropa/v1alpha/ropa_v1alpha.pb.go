...
type RopaEntry_AutomatedEntry struct {
	...
	// References to entities that are responsible for data processing.
	DataProcessorReferences []*RopaEntry_DataProcessorRef `protobuf:"bytes,1,rep,name=data_processor_references,json=dataProcessorReferences,proto3" json:"data_processor_references,omitempty"`
	// The data contract that is used for data processing
	// TODO decide whether this can be repeated or not
	DataContractReference *v1.DataContractRef `protobuf:"bytes,2,opt,name=data_contract_reference,json=dataContractReference,proto3" json:"data_contract_reference,omitempty"`
	// Which company is the owner of the data, who controls it?
	DataController *RopaEntry_DataActor `protobuf:"bytes,3,opt,name=data_controller,json=dataController,proto3" json:"data_controller,omitempty"`
	// Which company is the processor of the data, who uses the data?
	DataProcessor *RopaEntry_DataActor `protobuf:"bytes,4,opt,name=data_processor,json=dataProcessor,proto3" json:"data_processor,omitempty"`
	...
	// TODO decide to use enum or string
	DataSubjectCategories []string `protobuf:"bytes,6,rep,name=data_subject_categories,json=dataSubjectCategories,proto3" json:"data_subject_categories,omitempty"`
	// What type of data is being processed?
	// e.g. browsing data, location data, contact details, transaction data, etc.
	ProcessedPersonalDataTypes []string `protobuf:"bytes,7,rep,name=processed_personal_data_types,json=processedPersonalDataTypes,proto3" json:"processed_personal_data_types,omitempty"`
	// Who receive the data?
	// TODO decide to use enum or string
	DataRecipients []string `protobuf:"bytes,8,rep,name=data_recipients,json=dataRecipients,proto3" json:"data_recipients,omitempty"`
	// TODO get more information on what this means
	DataTransferDetails string `protobuf:"bytes,9,opt,name=data_transfer_details,json=dataTransferDetails,proto3" json:"data_transfer_details,omitempty"`
	// How long should the data be kept?
	DataRetention *RopaEntry_DataRetention `protobuf:"bytes,10,opt,name=data_retention,json=dataRetention,proto3" json:"data_retention,omitempty"`
	// TODO decide to use enum or string
	...
	DataSecurityMeasures []string `protobuf:"bytes,11,rep,name=data_security_measures,json=dataSecurityMeasures,proto3" json:"data_security_measures,omitempty"`
	// What is the legal basis for the processing of the data?
	LegalBasis []string `protobuf:"bytes,12,rep,name=legal_basis,json=legalBasis,proto3" json:"legal_basis,omitempty"`
	// What actions are taken to ensure that only the minimum amount of data is processed to achieve the goal?
	DataMinimizationProcedures []string `protobuf:"bytes,13,rep,name=data_minimization_procedures,json=dataMinimizationProcedures,proto3" json:"data_minimization_procedures,omitempty"`
	// What actions are taken to ensure data access follows the principle of least privilege?
	DataAccessProcedures []string `protobuf:"bytes,14,rep,name=data_access_procedures,json=dataAccessProcedures,proto3" json:"data_access_procedures,omitempty"`
	// What data breach response plans are in place? What are the actions that are taken when a data breach occurs?
	DataBreachResponsePlans []string `protobuf:"bytes,15,rep,name=data_breach_response_plans,json=dataBreachResponsePlans,proto3" json:"data_breach_response_plans,omitempty"`
	// The information systems used to process the data.
	InformationSystems []string `protobuf:"bytes,16,rep,name=information_systems,json=informationSystems,proto3" json:"information_systems,omitempty"`
	...
	AdditionalInformation map[string]string `protobuf:"bytes,17,rep,name=additional_information,json=additionalInformation,proto3" json:"additional_information,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *RopaEntry_AutomatedEntry) GetDataProcessorReferences() []*RopaEntry_DataProcessorRef {
	if x != nil {
		return x.DataProcessorReferences
	}
	return nil
}
...
type RopaEntry_DataProcessorRef struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*RopaEntry_DataProcessorRef_Stream
	//	*RopaEntry_DataProcessorRef_KeyStream
	//	*RopaEntry_DataProcessorRef_BatchJob
	Ref isRopaEntry_DataProcessorRef_Ref `protobuf_oneof:"ref"`
}

func (x *RopaEntry_DataProcessorRef) Reset() {
	*x = RopaEntry_DataProcessorRef{}
	if protoimpl.UnsafeEnabled {
...
func (x *RopaEntry_DataProcessorRef) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RopaEntry_DataProcessorRef) ProtoMessage() {}

func (x *RopaEntry_DataProcessorRef) ProtoReflect() protoreflect.Message {
	mi := &file_strmprivacy_api_ropa_v1alpha_ropa_v1alpha_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RopaEntry_DataProcessorRef.ProtoReflect.Descriptor instead.
func (*RopaEntry_DataProcessorRef) Descriptor() ([]byte, []int) {
	return file_strmprivacy_api_ropa_v1alpha_ropa_v1alpha_proto_rawDescGZIP(), []int{5, 2}
}

func (m *RopaEntry_DataProcessorRef) GetRef() isRopaEntry_DataProcessorRef_Ref {
	if m != nil {
		return m.Ref
	}
	return nil
...
func (x *RopaEntry_DataProcessorRef) GetStream() *v1.StreamRef {
	if x, ok := x.GetRef().(*RopaEntry_DataProcessorRef_Stream); ok {
		return x.Stream
	}
	return nil
}

func (x *RopaEntry_DataProcessorRef) GetKeyStream() *v1.KeyStreamRef {
	if x, ok := x.GetRef().(*RopaEntry_DataProcessorRef_KeyStream); ok {
		return x.KeyStream
	}
	return nil
}

func (x *RopaEntry_DataProcessorRef) GetBatchJob() *v1.BatchJobRef {
	if x, ok := x.GetRef().(*RopaEntry_DataProcessorRef_BatchJob); ok {
		return x.BatchJob
	}
	return nil
}

type isRopaEntry_DataProcessorRef_Ref interface {
	isRopaEntry_DataProcessorRef_Ref()
}

type RopaEntry_DataProcessorRef_Stream struct {
	Stream *v1.StreamRef `protobuf:"bytes,1,opt,name=stream,proto3,oneof"`
}

type RopaEntry_DataProcessorRef_KeyStream struct {
	KeyStream *v1.KeyStreamRef `protobuf:"bytes,2,opt,name=key_stream,json=keyStream,proto3,oneof"`
}

type RopaEntry_DataProcessorRef_BatchJob struct {
	BatchJob *v1.BatchJobRef `protobuf:"bytes,3,opt,name=batch_job,json=batchJob,proto3,oneof"`
}

func (*RopaEntry_DataProcessorRef_Stream) isRopaEntry_DataProcessorRef_Ref() {}

func (*RopaEntry_DataProcessorRef_KeyStream) isRopaEntry_DataProcessorRef_Ref() {}

func (*RopaEntry_DataProcessorRef_BatchJob) isRopaEntry_DataProcessorRef_Ref() {}
...
type RopaEntry_DataRetention_UntilProcessIsFinished struct {
	...
	FinishTime  *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=finish_time,json=finishTime,proto3" json:"finish_time,omitempty"`
...
func (x *RopaEntry_DataRetention_UntilProcessIsFinished) GetFinishTime() *timestamppb.Timestamp {
	if x != nil {
		return x.FinishTime
	}
	return nil
...
var file_strmprivacy_api_ropa_v1alpha_ropa_v1alpha_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0xcd, 0x14, 0x0a, 0x09, 0x52, 0x6f, 0x70, 0x61,
	...
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x86, 0x0a, 0x0a, 0x0e, 0x41, 0x75,
	0x74, 0x6f, 0x6d, 0x61, 0x74, 0x65, 0x64, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x74, 0x0a, 0x19,
	0x64, 0x61, 0x74, 0x61, 0x5f, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x6f, 0x72, 0x5f, 0x72,
	...
	0x69, 0x2e, 0x72, 0x6f, 0x70, 0x61, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x52,
	0x6f, 0x70, 0x61, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x50, 0x72, 0x6f,
	0x63, 0x65, 0x73, 0x73, 0x6f, 0x72, 0x52, 0x65, 0x66, 0x52, 0x17, 0x64, 0x61, 0x74, 0x61, 0x50,
	0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x6f, 0x72, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63,
	0x65, 0x73, 0x12, 0x64, 0x0a, 0x17, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x72,
	0x61, 0x63, 0x74, 0x5f, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x02, 0x20,
	...
	0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x63, 0x65, 0x73, 0x73, 0x6f, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x73,
	...
	0x0a, 0x08, 0x70, 0x75, 0x72, 0x70, 0x6f, 0x73, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09,
	...
	0x6f, 0x72, 0x69, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x52, 0x15, 0x64, 0x61, 0x74,
	...
	0x70, 0x65, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x09, 0x52, 0x1a, 0x70, 0x72, 0x6f, 0x63, 0x65,
	...
	0x63, 0x69, 0x70, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e,
	...
	0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x64,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e, 0x73, 0x74, 0x72,
	...
	0x79, 0x5f, 0x6d, 0x65, 0x61, 0x73, 0x75, 0x72, 0x65, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x09,
	...
	0x62, 0x61, 0x73, 0x69, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x6c, 0x65, 0x67,
	...
	0x63, 0x65, 0x64, 0x75, 0x72, 0x65, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x09, 0x52, 0x1a, 0x64,
	...
	0x72, 0x65, 0x73, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x09, 0x52, 0x14, 0x64, 0x61, 0x74, 0x61, 0x41,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x5f, 0x70, 0x6c, 0x61, 0x6e, 0x73, 0x18, 0x0f, 0x20,
	...
	0x65, 0x6d, 0x73, 0x18, 0x10, 0x20, 0x03, 0x28, 0x09, 0x52, 0x12, 0x69, 0x6e, 0x66, 0x6f, 0x72,
	...
	0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x11, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x51,
	0x2e, 0x73, 0x74, 0x72, 0x6d, 0x70, 0x72, 0x69, 0x76, 0x61, 0x63, 0x79, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x72, 0x6f, 0x70, 0x61, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x52, 0x6f,
	...
	0x38, 0x01, 0x1a, 0xf0, 0x01, 0x0a, 0x10, 0x44, 0x61, 0x74, 0x61, 0x50, 0x72, 0x6f, 0x63, 0x65,
	0x73, 0x73, 0x6f, 0x72, 0x52, 0x65, 0x66, 0x12, 0x40, 0x0a, 0x06, 0x73, 0x74, 0x72, 0x65, 0x61,
	0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x73, 0x74, 0x72, 0x6d, 0x70, 0x72,
	...
	0x00, 0x52, 0x06, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x4a, 0x0a, 0x0a, 0x6b, 0x65, 0x79,
	0x5f, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e,
	...
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x66, 0x48, 0x00, 0x52, 0x09, 0x6b, 0x65, 0x79, 0x53,
	...
	,
	...
	,
	...
	0x76, 0x33, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x72, 0x6f, 0x70, 0x61, 0x2f, 0x76, 0x31, 0x61, 0x6c,
	0x70, 0x68, 0x61, 0x3b, 0x72, 0x6f, 0x70, 0x61, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_strmprivacy_api_ropa_v1alpha_ropa_v1alpha_proto_goTypes = []interface{}{
	...
	(*RopaEntry_DataProcessorRef)(nil),                           // 13: strmprivacy.api.ropa.v1alpha.RopaEntry.DataProcessorRef
...
var file_strmprivacy_api_ropa_v1alpha_ropa_v1alpha_proto_depIdxs = []int32{
	...
	13, // 12: strmprivacy.api.ropa.v1alpha.RopaEntry.AutomatedEntry.data_processor_references:type_name -> strmprivacy.api.ropa.v1alpha.RopaEntry.DataProcessorRef
	21, // 13: strmprivacy.api.ropa.v1alpha.RopaEntry.AutomatedEntry.data_contract_reference:type_name -> strmprivacy.api.entities.v1.DataContractRef
	14, // 14: strmprivacy.api.ropa.v1alpha.RopaEntry.AutomatedEntry.data_controller:type_name -> strmprivacy.api.ropa.v1alpha.RopaEntry.DataActor
	14, // 15: strmprivacy.api.ropa.v1alpha.RopaEntry.AutomatedEntry.data_processor:type_name -> strmprivacy.api.ropa.v1alpha.RopaEntry.DataActor
	15, // 16: strmprivacy.api.ropa.v1alpha.RopaEntry.AutomatedEntry.data_retention:type_name -> strmprivacy.api.ropa.v1alpha.RopaEntry.DataRetention
	16, // 17: strmprivacy.api.ropa.v1alpha.RopaEntry.AutomatedEntry.additional_information:type_name -> strmprivacy.api.ropa.v1alpha.RopaEntry.AutomatedEntry.AdditionalInformationEntry
	22, // 18: strmprivacy.api.ropa.v1alpha.RopaEntry.DataProcessorRef.stream:type_name -> strmprivacy.api.entities.v1.StreamRef
	23, // 19: strmprivacy.api.ropa.v1alpha.RopaEntry.DataProcessorRef.key_stream:type_name -> strmprivacy.api.entities.v1.KeyStreamRef
	24, // 20: strmprivacy.api.ropa.v1alpha.RopaEntry.DataProcessorRef.batch_job:type_name -> strmprivacy.api.entities.v1.BatchJobRef
	17, // 21: strmprivacy.api.ropa.v1alpha.RopaEntry.DataRetention.fixed_time:type_name -> strmprivacy.api.ropa.v1alpha.RopaEntry.DataRetention.FixedTime
	18, // 22: strmprivacy.api.ropa.v1alpha.RopaEntry.DataRetention.until_process_is_finished:type_name -> strmprivacy.api.ropa.v1alpha.RopaEntry.DataRetention.UntilProcessIsFinished
	19, // 23: strmprivacy.api.ropa.v1alpha.RopaEntry.DataRetention.after_relationship_termination:type_name -> strmprivacy.api.ropa.v1alpha.RopaEntry.DataRetention.AfterRelationshipTermination
	25, // 24: strmprivacy.api.ropa.v1alpha.RopaEntry.DataRetention.FixedTime.duration:type_name -> google.protobuf.Duration
	20, // 25: strmprivacy.api.ropa.v1alpha.RopaEntry.DataRetention.UntilProcessIsFinished.finish_time:type_name -> google.protobuf.Timestamp
...
func file_strmprivacy_api_ropa_v1alpha_ropa_v1alpha_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_strmprivacy_api_ropa_v1alpha_ropa_v1alpha_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RopaEntry_DataProcessorRef); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_strmprivacy_api_ropa_v1alpha_ropa_v1alpha_proto_msgTypes[12].OneofWrappers = []interface{}{
		(*RopaEntry_DataProcessorRef_Stream)(nil),
		(*RopaEntry_DataProcessorRef_KeyStream)(nil),
		(*RopaEntry_DataProcessorRef_BatchJob)(nil),
	}
