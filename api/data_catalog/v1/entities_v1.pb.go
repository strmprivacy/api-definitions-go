...
const (
	...
	CatalogType_DATAHUB                  CatalogType = 1
)
...
func (Relation_Direction) Descriptor() protoreflect.EnumDescriptor {
	return file_strmprivacy_api_data_catalog_v1_entities_v1_proto_enumTypes[3].Descriptor()
}

func (Relation_Direction) Type() protoreflect.EnumType {
	return &file_strmprivacy_api_data_catalog_v1_entities_v1_proto_enumTypes[3]
}
...
func (Relation_Direction) EnumDescriptor() ([]byte, []int) {
	return file_strmprivacy_api_data_catalog_v1_entities_v1_proto_rawDescGZIP(), []int{7, 0}
}
...
type Dataset struct {
	...
	DatasetRef *DatasetRef `protobuf:"bytes,1,opt,name=dataset_ref,json=datasetRef,proto3" json:"dataset_ref,omitempty"`
	Schema     *Schema     `protobuf:"bytes,2,opt,name=schema,proto3" json:"schema,omitempty"`
	Tags       []*Tag      `protobuf:"bytes,3,rep,name=tags,proto3" json:"tags,omitempty"`
	// the origin of the dataset. Might be empty
	DataCatalog *DataCatalogRef `protobuf:"bytes,4,opt,name=data_catalog,json=dataCatalog,proto3" json:"data_catalog,omitempty"`
...
func (x *Dataset) GetDatasetRef() *DatasetRef {
	if x != nil {
		return x.DatasetRef
	}
	return nil
...
func (x *Dataset) GetDataCatalog() *DataCatalogRef {
	if x != nil {
...
type DatasetRef struct {
	...
	// The platform is responsible for storing and executing queries on the data. Example = Snowflake
	PlatformRef *DataPlatformRef `protobuf:"bytes,1,opt,name=platform_ref,json=platformRef,proto3" json:"platform_ref,omitempty"`
	// The absolute path within the platform to the dataset (<database>.<database_schema>.<table>)
	Address string `protobuf:"bytes,2,opt,name=address,proto3" json:"address,omitempty"`
	// urn uniquely identifies this dataset within DCET
...
func (x *DatasetRef) GetPlatformRef() *DataPlatformRef {
	if x != nil {
...
func (x *DatasetRef) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *DatasetRef) GetUrn() string {
	if x != nil {
		return x.Urn
	}
	return ""
...
func (x *DatasetRef) GetOriginUrn() string {
	if x != nil {
		return x.OriginUrn
	}
	return ""
...
// A DatasetConnection provides access to the data that resides on the Data Platform
type DatasetConnection struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The credentials that provide access to the datasets on the platforms (so not to the data catalog)
	Credentials string      `protobuf:"bytes,1,opt,name=credentials,proto3" json:"credentials,omitempty"`
	DatasetRef  *DatasetRef `protobuf:"bytes,2,opt,name=dataset_ref,json=datasetRef,proto3" json:"dataset_ref,omitempty"`
	// urn uniquely identifies this dataset connection within DCET
	Urn string `protobuf:"bytes,3,opt,name=urn,proto3" json:"urn,omitempty"`
	// urn used on the data platform
	OriginUrn string `protobuf:"bytes,4,opt,name=origin_urn,json=originUrn,proto3" json:"origin_urn,omitempty"`
}

func (x *DatasetConnection) Reset() {
	*x = DatasetConnection{}
	if protoimpl.UnsafeEnabled {
...
func (x *DatasetConnection) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DatasetConnection) ProtoMessage() {}

func (x *DatasetConnection) ProtoReflect() protoreflect.Message {
	mi := &file_strmprivacy_api_data_catalog_v1_entities_v1_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DatasetConnection.ProtoReflect.Descriptor instead.
func (*DatasetConnection) Descriptor() ([]byte, []int) {
	return file_strmprivacy_api_data_catalog_v1_entities_v1_proto_rawDescGZIP(), []int{2}
}

func (x *DatasetConnection) GetCredentials() string {
	if x != nil {
...
func (x *DatasetConnection) GetDatasetRef() *DatasetRef {
	if x != nil {
		return x.DatasetRef
	}
	return nil
...
func (x *DatasetConnection) GetUrn() string {
	if x != nil {
		return x.Urn
	}
	return ""
...
func (x *DatasetConnection) GetOriginUrn() string {
	if x != nil {
		return x.OriginUrn
	}
	return ""
...
func (x *SchemaField) GetOriginUrn() string {
	if x != nil {
		return x.OriginUrn
	}
	return ""
...
type DataCatalogRef struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CatalogType CatalogType `protobuf:"varint,1,opt,name=catalog_type,json=catalogType,proto3,enum=strmprivacy.api.data_catalog.v1.CatalogType" json:"catalog_type,omitempty"`
	Name        string      `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// urn uniquely identifies this platform within DCET
	Urn string `protobuf:"bytes,3,opt,name=urn,proto3" json:"urn,omitempty"`
}

func (x *DataCatalogRef) Reset() {
	*x = DataCatalogRef{}
	if protoimpl.UnsafeEnabled {
...
func (x *DataCatalogRef) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DataCatalogRef) ProtoMessage() {}

func (x *DataCatalogRef) ProtoReflect() protoreflect.Message {
	mi := &file_strmprivacy_api_data_catalog_v1_entities_v1_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DataCatalogRef.ProtoReflect.Descriptor instead.
func (*DataCatalogRef) Descriptor() ([]byte, []int) {
	return file_strmprivacy_api_data_catalog_v1_entities_v1_proto_rawDescGZIP(), []int{8}
}

func (x *DataCatalogRef) GetCatalogType() CatalogType {
	if x != nil {
...
func (x *DataCatalogRef) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *DataCatalogRef) GetUrn() string {
	if x != nil {
		return x.Urn
	}
	return ""
...
type DataCatalog struct {
	...
	Ref         *DataCatalogRef `protobuf:"bytes,1,opt,name=ref,proto3" json:"ref,omitempty"`
	Credentials *Credentials    `protobuf:"bytes,2,opt,name=credentials,proto3" json:"credentials,omitempty"`
	// access uri to the data catalog
...
func (x *DataCatalog) GetRef() *DataCatalogRef {
	if x != nil {
		return x.Ref
	}
	return nil
...
func (x *DataCatalog) GetCredentials() *Credentials {
	if x != nil {
		return x.Credentials
	}
	return nil
...
func (x *DataCatalog) GetUri() string {
	if x != nil {
		return x.Uri
	}
	return ""
...
type Credentials_Unauthenticated_ struct {
	Unauthenticated *Credentials_Unauthenticated `protobuf:"bytes,1,opt,name=unauthenticated,proto3,oneof"`
}

type Credentials_Basic_ struct {
	Basic *Credentials_Basic `protobuf:"bytes,2,opt,name=basic,proto3,oneof"`
}
...
type DataPlatformRef struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// type is for instance Postgres, Kafka, CSV file, Databricks.
	Type DataPlatformType `protobuf:"varint,1,opt,name=type,proto3,enum=strmprivacy.api.data_catalog.v1.DataPlatformType" json:"type,omitempty"`
...
func (x *DataPlatformRef) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DataPlatformRef) ProtoMessage() {}

func (x *DataPlatformRef) ProtoReflect() protoreflect.Message {
	mi := &file_strmprivacy_api_data_catalog_v1_entities_v1_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DataPlatformRef.ProtoReflect.Descriptor instead.
func (*DataPlatformRef) Descriptor() ([]byte, []int) {
	return file_strmprivacy_api_data_catalog_v1_entities_v1_proto_rawDescGZIP(), []int{11}
}

func (x *DataPlatformRef) GetType() DataPlatformType {
	if x != nil {
		return x.Type
	}
...
func (x *DataPlatformRef) GetInstance() string {
	if x != nil {
		return x.Instance
	}
	return ""
...
func (x *DataPlatformRef) GetUrn() string {
	if x != nil {
		return x.Urn
	}
	return ""
...
func (x *DataPlatformRef) GetLogoUri() string {
	if x != nil {
		return x.LogoUri
	}
	return ""
...
func (x *DataPlatformRef) GetOriginUrn() string {
	if x != nil {
		return x.OriginUrn
	}
	return ""
...
var file_strmprivacy_api_data_catalog_v1_entities_v1_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc3, 0x03, 0x0a, 0x07, 0x44, 0x61, 0x74, 0x61, 0x73, 0x65,
	0x74, 0x12, 0x4c, 0x0a, 0x0b, 0x64, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x5f, 0x72, 0x65, 0x66,
	...
	0x52, 0x65, 0x66, 0x52, 0x0a, 0x64, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x52, 0x65, 0x66, 0x12,
	...
	0x2e, 0x54, 0x61, 0x67, 0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x12, 0x52, 0x0a, 0x0c, 0x64, 0x61,
	0x74, 0x61, 0x5f, 0x63, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x2f, 0x2e, 0x73, 0x74, 0x72, 0x6d, 0x70, 0x72, 0x69, 0x76, 0x61, 0x63, 0x79, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x63, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67, 0x2e,
	0x76, 0x31, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x43, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67, 0x52, 0x65,
	0x66, 0x52, 0x0b, 0x64, 0x61, 0x74, 0x61, 0x43, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67, 0x12, 0x47,
	...
	,
	...
	0xb9, 0x01, 0x0a, 0x11, 0x44, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x6e, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x20, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x61, 0x6c, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x72, 0x65, 0x64,
	0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x12, 0x4c, 0x0a, 0x0b, 0x64, 0x61, 0x74, 0x61, 0x73,
	0x65, 0x74, 0x5f, 0x72, 0x65, 0x66, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x73,
	...
	,
	...
	,
	...
	0x69, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x63, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67, 0x2e, 0x76,
	0x31, 0x2e, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x44, 0x69, 0x72, 0x65, 0x63,
	...
	0x09, 0x52, 0x08, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x10, 0x0a, 0x03, 0x75,
	0x72, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6e, 0x12, 0x22, 0x0a,
	0x0a, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x5f, 0x75, 0x72, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x03, 0xe0, 0x41, 0x01, 0x52, 0x09, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x55, 0x72,
	0x6e, 0x22, 0x43, 0x0a, 0x09, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x19,
	...
	,
	...
	0x22, 0xc4, 0x01, 0x0a, 0x0b, 0x44, 0x61, 0x74, 0x61, 0x43, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67,
	0x12, 0x41, 0x0a, 0x03, 0x72, 0x65, 0x66, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e,
	...
	,
	...
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x63, 0x61, 0x74, 0x61, 0x6c, 0x6f,
	0x67, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73,
	...
	0x74, 0x65, 0x64, 0x12, 0x4a, 0x0a, 0x05, 0x62, 0x61, 0x73, 0x69, 0x63, 0x18, 0x02, 0x20, 0x01,
	...
	,
	...
	0x75, 0x72, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6e, 0x12, 0x1e,
	0x0a, 0x08, 0x6c, 0x6f, 0x67, 0x6f, 0x5f, 0x75, 0x72, 0x69, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x42, 0x03, 0xe0, 0x41, 0x01, 0x52, 0x07, 0x6c, 0x6f, 0x67, 0x6f, 0x55, 0x72, 0x69, 0x12, 0x22,
	0x0a, 0x0a, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x5f, 0x75, 0x72, 0x6e, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x01, 0x52, 0x09, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x55,
	0x72, 0x6e, 0x2a, 0x65, 0x0a, 0x0f, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x46, 0x69, 0x65, 0x6c,
	0x64, 0x54, 0x79, 0x70, 0x65, 0x12, 0x21, 0x0a, 0x1d, 0x53, 0x43, 0x48, 0x45, 0x4d, 0x41, 0x5f,
	...
	,
	...
	0x61, 0x70, 0x69, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x63, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67,
	0x2f, 0x76, 0x31, 0x3b, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x63, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67,
...
var file_strmprivacy_api_data_catalog_v1_entities_v1_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_strmprivacy_api_data_catalog_v1_entities_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_strmprivacy_api_data_catalog_v1_entities_v1_proto_goTypes = []interface{}{
	...
	(CatalogType)(0),                    // 2: strmprivacy.api.data_catalog.v1.CatalogType
	(Relation_Direction)(0),             // 3: strmprivacy.api.data_catalog.v1.Relation.Direction
	(*Dataset)(nil),                     // 4: strmprivacy.api.data_catalog.v1.Dataset
	(*DatasetRef)(nil),                  // 5: strmprivacy.api.data_catalog.v1.DatasetRef
	(*DatasetConnection)(nil),           // 6: strmprivacy.api.data_catalog.v1.DatasetConnection
	(*Schema)(nil),                      // 7: strmprivacy.api.data_catalog.v1.Schema
	(*SchemaField)(nil),                 // 8: strmprivacy.api.data_catalog.v1.SchemaField
	(*Tag)(nil),                         // 9: strmprivacy.api.data_catalog.v1.Tag
	(*Owner)(nil),                       // 10: strmprivacy.api.data_catalog.v1.Owner
	(*Relation)(nil),                    // 11: strmprivacy.api.data_catalog.v1.Relation
	(*DataCatalogRef)(nil),              // 12: strmprivacy.api.data_catalog.v1.DataCatalogRef
	(*DataCatalog)(nil),                 // 13: strmprivacy.api.data_catalog.v1.DataCatalog
	(*Credentials)(nil),                 // 14: strmprivacy.api.data_catalog.v1.Credentials
	(*DataPlatformRef)(nil),             // 15: strmprivacy.api.data_catalog.v1.DataPlatformRef
	(*Credentials_Unauthenticated)(nil), // 16: strmprivacy.api.data_catalog.v1.Credentials.Unauthenticated
	(*Credentials_Basic)(nil),           // 17: strmprivacy.api.data_catalog.v1.Credentials.Basic
}
var file_strmprivacy_api_data_catalog_v1_entities_v1_proto_depIdxs = []int32{
	5,  // 0: strmprivacy.api.data_catalog.v1.Dataset.dataset_ref:type_name -> strmprivacy.api.data_catalog.v1.DatasetRef
	7,  // 1: strmprivacy.api.data_catalog.v1.Dataset.schema:type_name -> strmprivacy.api.data_catalog.v1.Schema
	9,  // 2: strmprivacy.api.data_catalog.v1.Dataset.tags:type_name -> strmprivacy.api.data_catalog.v1.Tag
	12, // 3: strmprivacy.api.data_catalog.v1.Dataset.data_catalog:type_name -> strmprivacy.api.data_catalog.v1.DataCatalogRef
	11, // 4: strmprivacy.api.data_catalog.v1.Dataset.relations:type_name -> strmprivacy.api.data_catalog.v1.Relation
	10, // 5: strmprivacy.api.data_catalog.v1.Dataset.owners:type_name -> strmprivacy.api.data_catalog.v1.Owner
	15, // 6: strmprivacy.api.data_catalog.v1.DatasetRef.platform_ref:type_name -> strmprivacy.api.data_catalog.v1.DataPlatformRef
	5,  // 7: strmprivacy.api.data_catalog.v1.DatasetConnection.dataset_ref:type_name -> strmprivacy.api.data_catalog.v1.DatasetRef
	8,  // 8: strmprivacy.api.data_catalog.v1.Schema.schema_fields:type_name -> strmprivacy.api.data_catalog.v1.SchemaField
	0,  // 9: strmprivacy.api.data_catalog.v1.SchemaField.type:type_name -> strmprivacy.api.data_catalog.v1.SchemaFieldType
	9,  // 10: strmprivacy.api.data_catalog.v1.SchemaField.tags:type_name -> strmprivacy.api.data_catalog.v1.Tag
	3,  // 11: strmprivacy.api.data_catalog.v1.Relation.direction:type_name -> strmprivacy.api.data_catalog.v1.Relation.Direction
	2,  // 12: strmprivacy.api.data_catalog.v1.DataCatalogRef.catalog_type:type_name -> strmprivacy.api.data_catalog.v1.CatalogType
	12, // 13: strmprivacy.api.data_catalog.v1.DataCatalog.ref:type_name -> strmprivacy.api.data_catalog.v1.DataCatalogRef
	14, // 14: strmprivacy.api.data_catalog.v1.DataCatalog.credentials:type_name -> strmprivacy.api.data_catalog.v1.Credentials
	16, // 15: strmprivacy.api.data_catalog.v1.Credentials.unauthenticated:type_name -> strmprivacy.api.data_catalog.v1.Credentials.Unauthenticated
	17, // 16: strmprivacy.api.data_catalog.v1.Credentials.basic:type_name -> strmprivacy.api.data_catalog.v1.Credentials.Basic
	1,  // 17: strmprivacy.api.data_catalog.v1.DataPlatformRef.type:type_name -> strmprivacy.api.data_catalog.v1.DataPlatformType
...
func file_strmprivacy_api_data_catalog_v1_entities_v1_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_strmprivacy_api_data_catalog_v1_entities_v1_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DatasetConnection); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
