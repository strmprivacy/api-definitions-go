...
const (
	...
	Category_DATA_SOURCE             Category_Type = 4
	Category_PERSONAL_DATA_TYPE      Category_Type = 5
	Category_PROCESSING              Category_Type = 6
	Category_SECURITY_MEASURE        Category_Type = 7
	Category_RETENTION_PERIOD_OFFSET Category_Type = 8
)
...
var (
	Category_Type_name = map[int32]string{
		...
		3: "DATA_RECIPIENT",
		4: "DATA_SOURCE",
		5: "PERSONAL_DATA_TYPE",
		6: "PROCESSING",
		7: "SECURITY_MEASURE",
		8: "RETENTION_PERIOD_OFFSET",
	}
	Category_Type_value = map[string]int32{
		...
		"DATA_RECIPIENT":          3,
		"DATA_SOURCE":             4,
		"PERSONAL_DATA_TYPE":      5,
		"PROCESSING":              6,
		"SECURITY_MEASURE":        7,
		"RETENTION_PERIOD_OFFSET": 8,
	}
)
...
// Todo: could be used in the backend (linking table). Not sure if we need it in the API.
type Ropa_PartyType int32

const (
	Ropa_PARTY_TYPE_UNSPECIFIED Ropa_PartyType = 0
	Ropa_CONTROLLER             Ropa_PartyType = 1
	Ropa_PROCESSOR              Ropa_PartyType = 2
	Ropa_DATA_RECIPIENT         Ropa_PartyType = 3
)

// Enum value maps for Ropa_PartyType.
var (
	Ropa_PartyType_name = map[int32]string{
		0: "PARTY_TYPE_UNSPECIFIED",
		1: "CONTROLLER",
		2: "PROCESSOR",
		3: "DATA_RECIPIENT",
	}
	Ropa_PartyType_value = map[string]int32{
...
func (x Ropa_PartyType) Enum() *Ropa_PartyType {
	p := new(Ropa_PartyType)
	*p = x
	return p
}

func (x Ropa_PartyType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Ropa_PartyType) Descriptor() protoreflect.EnumDescriptor {
	return file_strmprivacy_api_entities_v1alpha_entities_v1alpha_proto_enumTypes[3].Descriptor()
}

func (Ropa_PartyType) Type() protoreflect.EnumType {
	return &file_strmprivacy_api_entities_v1alpha_entities_v1alpha_proto_enumTypes[3]
}

func (x Ropa_PartyType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Ropa_PartyType.Descriptor instead.
func (Ropa_PartyType) EnumDescriptor() ([]byte, []int) {
...
// It can be an organization, but also a person, a department, a team, a system, etc.
// Todo: I didn't scope Party, Category and DataSource under RoPA after all. They feel more generic, each with their own service.
type Party struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DataSource) GetCategories() []*Category {
	if x != nil {
		return x.Categories
	}
	return nil
...
func (x *DataSource) GetHostingParty() *Party {
	if x != nil {
...
func (x *DataSource) GetContactPersonName() string {
	if x != nil {
...
func (x *DataSource) GetRegionCode() string {
	if x != nil {
		return x.RegionCode
	}
	return ""
...
type Ropa_Record struct {
	...
	UpdateUser     *v1.User               `protobuf:"bytes,4,opt,name=update_user,json=updateUser,proto3" json:"update_user,omitempty"`
	Version        int32                  `protobuf:"varint,5,opt,name=version,proto3" json:"version,omitempty"`
	// Related parties
	Controllers    []*Party `protobuf:"bytes,6,rep,name=controllers,proto3" json:"controllers,omitempty"`
	Processors     []*Party `protobuf:"bytes,7,rep,name=processors,proto3" json:"processors,omitempty"`
	DataRecipients []*Party `protobuf:"bytes,8,rep,name=data_recipients,json=dataRecipients,proto3" json:"data_recipients,omitempty"`
	// Purposes
	Purposes []*v1.PurposeMapping `protobuf:"bytes,9,rep,name=purposes,proto3" json:"purposes,omitempty"`
	// Related categories, some may be derived from the data contract
	DataCategories          []*Category `protobuf:"bytes,10,rep,name=data_categories,json=dataCategories,proto3" json:"data_categories,omitempty"`
	DataSubjectCategories   []*Category `protobuf:"bytes,11,rep,name=data_subject_categories,json=dataSubjectCategories,proto3" json:"data_subject_categories,omitempty"`
	DataRecipientCategories []*Category `protobuf:"bytes,12,rep,name=data_recipient_categories,json=dataRecipientCategories,proto3" json:"data_recipient_categories,omitempty"`
	PersonalDataTypes       []*Category `protobuf:"bytes,13,rep,name=personal_data_types,json=personalDataTypes,proto3" json:"personal_data_types,omitempty"`
	ProcessingCategories    []*Category `protobuf:"bytes,14,rep,name=processing_categories,json=processingCategories,proto3" json:"processing_categories,omitempty"`
	SecurityMeasures        []*Category `protobuf:"bytes,15,rep,name=security_measures,json=securityMeasures,proto3" json:"security_measures,omitempty"`
	// Linked data contract, if applicable
	DataContractRef *v1.DataContractRef `protobuf:"bytes,16,opt,name=data_contract_ref,json=dataContractRef,proto3" json:"data_contract_ref,omitempty"`
	// Data sources
	DataSources []*DataSource `protobuf:"bytes,17,rep,name=data_sources,json=dataSources,proto3" json:"data_sources,omitempty"`
	// Data transfer details (free text for now)
	DataTransferDetails string `protobuf:"bytes,18,opt,name=data_transfer_details,json=dataTransferDetails,proto3" json:"data_transfer_details,omitempty"`
	// Data retention policies
	// Todo: I think we can just reuse the policies as they are. The period is has a minimum granularity of days, but we can change that later if needed.
	DataRetentionPolicies []*v1.Policy `protobuf:"bytes,19,rep,name=data_retention_policies,json=dataRetentionPolicies,proto3" json:"data_retention_policies,omitempty"`
...
func (x *Ropa_Record) GetControllers() []*Party {
	if x != nil {
...
func (x *Ropa_Record) GetProcessors() []*Party {
	if x != nil {
		return x.Processors
	}
	return nil
...
func (x *Ropa_Record) GetDataRecipients() []*Party {
	if x != nil {
...
func (x *Ropa_Record) GetPurposes() []*v1.PurposeMapping {
	if x != nil {
		return x.Purposes
	}
	return nil
...
func (x *Ropa_Record) GetDataCategories() []*Category {
	if x != nil {
...
func (x *Ropa_Record) GetDataSubjectCategories() []*Category {
	if x != nil {
...
func (x *Ropa_Record) GetDataRecipientCategories() []*Category {
	if x != nil {
		return x.DataRecipientCategories
	}
	return nil
}

func (x *Ropa_Record) GetPersonalDataTypes() []*Category {
	if x != nil {
		return x.PersonalDataTypes
	}
	return nil
}

func (x *Ropa_Record) GetProcessingCategories() []*Category {
	if x != nil {
		return x.ProcessingCategories
	}
	return nil
}

func (x *Ropa_Record) GetSecurityMeasures() []*Category {
	if x != nil {
		return x.SecurityMeasures
	}
	return nil
}

func (x *Ropa_Record) GetDataContractRef() *v1.DataContractRef {
	if x != nil {
...
func (x *Ropa_Record) GetDataSources() []*DataSource {
	if x != nil {
...
func (x *Ropa_Record) GetDataRetentionPolicies() []*v1.Policy {
	if x != nil {
...
var file_strmprivacy_api_entities_v1alpha_entities_v1alpha_proto_rawDesc = []byte{
	...
	0x45, 0x52, 0x10, 0x04, 0x22, 0xdd, 0x01, 0x0a, 0x05, 0x50, 0x61, 0x72, 0x74, 0x79, 0x12, 0x1b,
	...
	0x61, 0x69, 0x6c, 0x73, 0x22, 0xbb, 0x02, 0x0a, 0x08, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72,
	...
	0x6d, 0x65, 0x12, 0x43, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e,
	...
	0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xb8, 0x01, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65,
	...
	,
	...
	0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d, 0x2e,
	0x73, 0x74, 0x72, 0x6d, 0x70, 0x72, 0x69, 0x76, 0x61, 0x63, 0x79, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61,
	0x2e, 0x52, 0x6f, 0x70, 0x61, 0x2e, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x07, 0x72, 0x65,
	0x63, 0x6f, 0x72, 0x64, 0x73, 0x1a, 0xb4, 0x0b, 0x0a, 0x06, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64,
	0x12, 0x1b, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0b, 0xfa, 0x42,
	0x08, 0x72, 0x06, 0xd0, 0x01, 0x01, 0xb0, 0x01, 0x01, 0x52, 0x02, 0x69, 0x64, 0x12, 0x27, 0x0a,
	...
	,
	...
	,
	...
	0x6c, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x61, 0x64,
	0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x5a, 0x0a, 0x09,
	...
	0x4c, 0x45, 0x52, 0x10, 0x01, 0x12, 0x0d, 0x0a, 0x09, 0x50, 0x52, 0x4f, 0x43, 0x45, 0x53, 0x53,
	0x4f, 0x52, 0x10, 0x02, 0x12, 0x12, 0x0a, 0x0e, 0x44, 0x41, 0x54, 0x41, 0x5f, 0x52, 0x45, 0x43,
	0x49, 0x50, 0x49, 0x45, 0x4e, 0x54, 0x10, 0x03, 0x42, 0x73, 0x0a, 0x23, 0x69, 0x6f, 0x2e, 0x73,
	0x74, 0x72, 0x6d, 0x70, 0x72, 0x69, 0x76, 0x61, 0x63, 0x79, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x65,
...
var file_strmprivacy_api_entities_v1alpha_entities_v1alpha_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_strmprivacy_api_entities_v1alpha_entities_v1alpha_proto_goTypes = []interface{}{
	...
	(Category_Type)(0),                                  // 2: strmprivacy.api.entities.v1alpha.Category.Type
	(Ropa_PartyType)(0),                                 // 3: strmprivacy.api.entities.v1alpha.Ropa.PartyType
	(*ProjectPlan)(nil),                                 // 4: strmprivacy.api.entities.v1alpha.ProjectPlan
	(*ItemGroup)(nil),                                   // 5: strmprivacy.api.entities.v1alpha.ItemGroup
	(*ItemProperties)(nil),                              // 6: strmprivacy.api.entities.v1alpha.ItemProperties
	(*TodoItems)(nil),                                   // 7: strmprivacy.api.entities.v1alpha.TodoItems
	(*DataContractItems)(nil),                           // 8: strmprivacy.api.entities.v1alpha.DataContractItems
	(*InfoAssetItems)(nil),                              // 9: strmprivacy.api.entities.v1alpha.InfoAssetItems
	(*DocumentItems)(nil),                               // 10: strmprivacy.api.entities.v1alpha.DocumentItems
	(*PipelineItems)(nil),                               // 11: strmprivacy.api.entities.v1alpha.PipelineItems
	(*FreeformItems)(nil),                               // 12: strmprivacy.api.entities.v1alpha.FreeformItems
	(*RiskAssessmentItems)(nil),                         // 13: strmprivacy.api.entities.v1alpha.RiskAssessmentItems
	(*RiskMitigationItems)(nil),                         // 14: strmprivacy.api.entities.v1alpha.RiskMitigationItems
	(*RecordingItems)(nil),                              // 15: strmprivacy.api.entities.v1alpha.RecordingItems
	(*InfoAsset)(nil),                                   // 16: strmprivacy.api.entities.v1alpha.InfoAsset
	(*ContactDetails)(nil),                              // 17: strmprivacy.api.entities.v1alpha.ContactDetails
	(*Party)(nil),                                       // 18: strmprivacy.api.entities.v1alpha.Party
	(*Category)(nil),                                    // 19: strmprivacy.api.entities.v1alpha.Category
	(*DataSource)(nil),                                  // 20: strmprivacy.api.entities.v1alpha.DataSource
	(*Ropa)(nil),                                        // 21: strmprivacy.api.entities.v1alpha.Ropa
	(*TodoItems_TodoItem)(nil),                          // 22: strmprivacy.api.entities.v1alpha.TodoItems.TodoItem
	(*DataContractItems_DataContractItem)(nil),          // 23: strmprivacy.api.entities.v1alpha.DataContractItems.DataContractItem
	(*InfoAssetItems_InfoAssetItem)(nil),                // 24: strmprivacy.api.entities.v1alpha.InfoAssetItems.InfoAssetItem
	(*InfoAssetItems_InfoAssetItem_Classification)(nil), // 25: strmprivacy.api.entities.v1alpha.InfoAssetItems.InfoAssetItem.Classification
	(*DocumentItems_DocumentItem)(nil),                  // 26: strmprivacy.api.entities.v1alpha.DocumentItems.DocumentItem
	(*PipelineItems_PipelineItem)(nil),                  // 27: strmprivacy.api.entities.v1alpha.PipelineItems.PipelineItem
	(*FreeformItems_Item)(nil),                          // 28: strmprivacy.api.entities.v1alpha.FreeformItems.Item
	(*RiskAssessmentItems_Item)(nil),                    // 29: strmprivacy.api.entities.v1alpha.RiskAssessmentItems.Item
	(*RiskMitigationItems_Item)(nil),                    // 30: strmprivacy.api.entities.v1alpha.RiskMitigationItems.Item
	(*RecordingItems_Item)(nil),                         // 31: strmprivacy.api.entities.v1alpha.RecordingItems.Item
	(*InfoAsset_Section)(nil),                           // 32: strmprivacy.api.entities.v1alpha.InfoAsset.Section
	(*InfoAsset_SubSection)(nil),                        // 33: strmprivacy.api.entities.v1alpha.InfoAsset.SubSection
	(*InfoAsset_Check)(nil),                             // 34: strmprivacy.api.entities.v1alpha.InfoAsset.Check
	(*InfoAsset_BusinessImpactRating)(nil),              // 35: strmprivacy.api.entities.v1alpha.InfoAsset.BusinessImpactRating
	(*InfoAsset_BusinessImpactCategory)(nil),            // 36: strmprivacy.api.entities.v1alpha.InfoAsset.BusinessImpactCategory
	(*Ropa_Record)(nil),                                 // 37: strmprivacy.api.entities.v1alpha.Ropa.Record
	(*v1.User)(nil),                                     // 38: strmprivacy.api.entities.v1.User
	(*timestamppb.Timestamp)(nil),                       // 39: google.protobuf.Timestamp
	(*v1.DataContractRef)(nil),                          // 40: strmprivacy.api.entities.v1.DataContractRef
	(*v1.StreamRef)(nil),                                // 41: strmprivacy.api.entities.v1.StreamRef
	(*v1.BatchJobRef)(nil),                              // 42: strmprivacy.api.entities.v1.BatchJobRef
	(*v1.PurposeMapping)(nil),                           // 43: strmprivacy.api.entities.v1.PurposeMapping
	(*v1.Policy)(nil),                                   // 44: strmprivacy.api.entities.v1.Policy
}
var file_strmprivacy_api_entities_v1alpha_entities_v1alpha_proto_depIdxs = []int32{
	5,  // 0: strmprivacy.api.entities.v1alpha.ProjectPlan.item_groups:type_name -> strmprivacy.api.entities.v1alpha.ItemGroup
	38, // 1: strmprivacy.api.entities.v1alpha.ProjectPlan.users:type_name -> strmprivacy.api.entities.v1.User
	7,  // 2: strmprivacy.api.entities.v1alpha.ItemGroup.todo_items:type_name -> strmprivacy.api.entities.v1alpha.TodoItems
	8,  // 3: strmprivacy.api.entities.v1alpha.ItemGroup.data_contract_items:type_name -> strmprivacy.api.entities.v1alpha.DataContractItems
	9,  // 4: strmprivacy.api.entities.v1alpha.ItemGroup.info_asset_items:type_name -> strmprivacy.api.entities.v1alpha.InfoAssetItems
	10, // 5: strmprivacy.api.entities.v1alpha.ItemGroup.document_items:type_name -> strmprivacy.api.entities.v1alpha.DocumentItems
	11, // 6: strmprivacy.api.entities.v1alpha.ItemGroup.pipeline_items:type_name -> strmprivacy.api.entities.v1alpha.PipelineItems
	12, // 7: strmprivacy.api.entities.v1alpha.ItemGroup.freeform_items:type_name -> strmprivacy.api.entities.v1alpha.FreeformItems
	13, // 8: strmprivacy.api.entities.v1alpha.ItemGroup.risk_assessment_items:type_name -> strmprivacy.api.entities.v1alpha.RiskAssessmentItems
	14, // 9: strmprivacy.api.entities.v1alpha.ItemGroup.risk_mitigation_items:type_name -> strmprivacy.api.entities.v1alpha.RiskMitigationItems
	15, // 10: strmprivacy.api.entities.v1alpha.ItemGroup.recording_items:type_name -> strmprivacy.api.entities.v1alpha.RecordingItems
	39, // 11: strmprivacy.api.entities.v1alpha.ItemProperties.creation_time:type_name -> google.protobuf.Timestamp
	39, // 12: strmprivacy.api.entities.v1alpha.ItemProperties.due_time:type_name -> google.protobuf.Timestamp
	39, // 13: strmprivacy.api.entities.v1alpha.ItemProperties.completion_time:type_name -> google.protobuf.Timestamp
	38, // 14: strmprivacy.api.entities.v1alpha.ItemProperties.creator:type_name -> strmprivacy.api.entities.v1.User
	38, // 15: strmprivacy.api.entities.v1alpha.ItemProperties.assignee:type_name -> strmprivacy.api.entities.v1.User
	22, // 16: strmprivacy.api.entities.v1alpha.TodoItems.items:type_name -> strmprivacy.api.entities.v1alpha.TodoItems.TodoItem
	23, // 17: strmprivacy.api.entities.v1alpha.DataContractItems.items:type_name -> strmprivacy.api.entities.v1alpha.DataContractItems.DataContractItem
	24, // 18: strmprivacy.api.entities.v1alpha.InfoAssetItems.items:type_name -> strmprivacy.api.entities.v1alpha.InfoAssetItems.InfoAssetItem
	26, // 19: strmprivacy.api.entities.v1alpha.DocumentItems.items:type_name -> strmprivacy.api.entities.v1alpha.DocumentItems.DocumentItem
	27, // 20: strmprivacy.api.entities.v1alpha.PipelineItems.items:type_name -> strmprivacy.api.entities.v1alpha.PipelineItems.PipelineItem
	28, // 21: strmprivacy.api.entities.v1alpha.FreeformItems.items:type_name -> strmprivacy.api.entities.v1alpha.FreeformItems.Item
	29, // 22: strmprivacy.api.entities.v1alpha.RiskAssessmentItems.items:type_name -> strmprivacy.api.entities.v1alpha.RiskAssessmentItems.Item
	30, // 23: strmprivacy.api.entities.v1alpha.RiskMitigationItems.items:type_name -> strmprivacy.api.entities.v1alpha.RiskMitigationItems.Item
	31, // 24: strmprivacy.api.entities.v1alpha.RecordingItems.items:type_name -> strmprivacy.api.entities.v1alpha.RecordingItems.Item
	35, // 25: strmprivacy.api.entities.v1alpha.InfoAsset.business_impacts:type_name -> strmprivacy.api.entities.v1alpha.InfoAsset.BusinessImpactRating
	32, // 26: strmprivacy.api.entities.v1alpha.InfoAsset.sections:type_name -> strmprivacy.api.entities.v1alpha.InfoAsset.Section
	...
	17, // 28: strmprivacy.api.entities.v1alpha.Party.contact_details:type_name -> strmprivacy.api.entities.v1alpha.ContactDetails
	2,  // 29: strmprivacy.api.entities.v1alpha.Category.type:type_name -> strmprivacy.api.entities.v1alpha.Category.Type
	19, // 30: strmprivacy.api.entities.v1alpha.DataSource.categories:type_name -> strmprivacy.api.entities.v1alpha.Category
	18, // 31: strmprivacy.api.entities.v1alpha.DataSource.hosting_party:type_name -> strmprivacy.api.entities.v1alpha.Party
	37, // 32: strmprivacy.api.entities.v1alpha.Ropa.records:type_name -> strmprivacy.api.entities.v1alpha.Ropa.Record
	6,  // 33: strmprivacy.api.entities.v1alpha.TodoItems.TodoItem.item_properties:type_name -> strmprivacy.api.entities.v1alpha.ItemProperties
	6,  // 34: strmprivacy.api.entities.v1alpha.DataContractItems.DataContractItem.item_properties:type_name -> strmprivacy.api.entities.v1alpha.ItemProperties
	40, // 35: strmprivacy.api.entities.v1alpha.DataContractItems.DataContractItem.ref:type_name -> strmprivacy.api.entities.v1.DataContractRef
	6,  // 36: strmprivacy.api.entities.v1alpha.InfoAssetItems.InfoAssetItem.item_properties:type_name -> strmprivacy.api.entities.v1alpha.ItemProperties
	...
	25, // 38: strmprivacy.api.entities.v1alpha.InfoAssetItems.InfoAssetItem.classification:type_name -> strmprivacy.api.entities.v1alpha.InfoAssetItems.InfoAssetItem.Classification
	16, // 39: strmprivacy.api.entities.v1alpha.InfoAssetItems.InfoAssetItem.info_asset:type_name -> strmprivacy.api.entities.v1alpha.InfoAsset
	6,  // 40: strmprivacy.api.entities.v1alpha.DocumentItems.DocumentItem.item_properties:type_name -> strmprivacy.api.entities.v1alpha.ItemProperties
	6,  // 41: strmprivacy.api.entities.v1alpha.PipelineItems.PipelineItem.item_properties:type_name -> strmprivacy.api.entities.v1alpha.ItemProperties
	41, // 42: strmprivacy.api.entities.v1alpha.PipelineItems.PipelineItem.stream:type_name -> strmprivacy.api.entities.v1.StreamRef
	42, // 43: strmprivacy.api.entities.v1alpha.PipelineItems.PipelineItem.batch_job:type_name -> strmprivacy.api.entities.v1.BatchJobRef
	6,  // 44: strmprivacy.api.entities.v1alpha.FreeformItems.Item.item_properties:type_name -> strmprivacy.api.entities.v1alpha.ItemProperties
	6,  // 45: strmprivacy.api.entities.v1alpha.RiskAssessmentItems.Item.item_properties:type_name -> strmprivacy.api.entities.v1alpha.ItemProperties
	6,  // 46: strmprivacy.api.entities.v1alpha.RiskMitigationItems.Item.item_properties:type_name -> strmprivacy.api.entities.v1alpha.ItemProperties
	6,  // 47: strmprivacy.api.entities.v1alpha.RecordingItems.Item.item_properties:type_name -> strmprivacy.api.entities.v1alpha.ItemProperties
	33, // 48: strmprivacy.api.entities.v1alpha.InfoAsset.Section.sub_sections:type_name -> strmprivacy.api.entities.v1alpha.InfoAsset.SubSection
	34, // 49: strmprivacy.api.entities.v1alpha.InfoAsset.SubSection.checks:type_name -> strmprivacy.api.entities.v1alpha.InfoAsset.Check
	36, // 50: strmprivacy.api.entities.v1alpha.InfoAsset.BusinessImpactRating.category:type_name -> strmprivacy.api.entities.v1alpha.InfoAsset.BusinessImpactCategory
	39, // 51: strmprivacy.api.entities.v1alpha.Ropa.Record.update_time:type_name -> google.protobuf.Timestamp
	38, // 52: strmprivacy.api.entities.v1alpha.Ropa.Record.update_user:type_name -> strmprivacy.api.entities.v1.User
	18, // 53: strmprivacy.api.entities.v1alpha.Ropa.Record.controllers:type_name -> strmprivacy.api.entities.v1alpha.Party
	18, // 54: strmprivacy.api.entities.v1alpha.Ropa.Record.processors:type_name -> strmprivacy.api.entities.v1alpha.Party
	18, // 55: strmprivacy.api.entities.v1alpha.Ropa.Record.data_recipients:type_name -> strmprivacy.api.entities.v1alpha.Party
	43, // 56: strmprivacy.api.entities.v1alpha.Ropa.Record.purposes:type_name -> strmprivacy.api.entities.v1.PurposeMapping
	19, // 57: strmprivacy.api.entities.v1alpha.Ropa.Record.data_categories:type_name -> strmprivacy.api.entities.v1alpha.Category
	19, // 58: strmprivacy.api.entities.v1alpha.Ropa.Record.data_subject_categories:type_name -> strmprivacy.api.entities.v1alpha.Category
	19, // 59: strmprivacy.api.entities.v1alpha.Ropa.Record.data_recipient_categories:type_name -> strmprivacy.api.entities.v1alpha.Category
	19, // 60: strmprivacy.api.entities.v1alpha.Ropa.Record.personal_data_types:type_name -> strmprivacy.api.entities.v1alpha.Category
	19, // 61: strmprivacy.api.entities.v1alpha.Ropa.Record.processing_categories:type_name -> strmprivacy.api.entities.v1alpha.Category
	19, // 62: strmprivacy.api.entities.v1alpha.Ropa.Record.security_measures:type_name -> strmprivacy.api.entities.v1alpha.Category
	40, // 63: strmprivacy.api.entities.v1alpha.Ropa.Record.data_contract_ref:type_name -> strmprivacy.api.entities.v1.DataContractRef
	20, // 64: strmprivacy.api.entities.v1alpha.Ropa.Record.data_sources:type_name -> strmprivacy.api.entities.v1alpha.DataSource
	44, // 65: strmprivacy.api.entities.v1alpha.Ropa.Record.data_retention_policies:type_name -> strmprivacy.api.entities.v1.Policy
